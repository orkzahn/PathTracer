...
public record Sphere(Vec3 pos, double rad, Material material) implements Shape{
    ...
    public BoundingBox bounds(){
        Vec3 min = new Vec3(pos.x() - rad(), pos.y() - rad(), pos.z()- rad());
        Vec3 max = new Vec3(pos.x() + rad(), pos.y() + rad(), pos.z()+ rad());
