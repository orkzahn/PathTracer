...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        var pointLWhiteFront = new PointLight(new Vec3(0, 5, 0), Color.white);

        var bg = new Background(bgEmission);
        var boden = new Plane(100000, mirror);

            
        var pengiunMesh = triangleToMesh("data/pen.obj", pengiunDiffuse);
        ...
        var pengiunStressTest = fillPlane(pengiunGroup, 6, 2);
        var robotStressTest = fillPlane(roboterGroup, 3, 2);

        
        Group root = new Group(identity(), Arrays.asList(
                 boden, bg, pengiunStressTest,robotStressTest));
